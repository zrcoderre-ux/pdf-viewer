...
const tests = [
  ...
  },
  {
    ...
    raw: "PLAINTIFF'S OPPOSITION TO DEFENDANT CALIFORNIA PHYSICIANS'SERVICE DBA BLUE SHIELD OF CALIFORNIA'S MOTION TO STRIKE PUNITIVE DAMAGES IN PLAINTIFF DANA ZAHLER'S SECOND AMENDED COMPLAINT",
  ...
  },
  {
    ...
    raw: "BLUE SHIELD'S NOTICE OF DEMURRER AND DEMURRER TO PLAINTIFF'S SAC CASE NO. 24STCP03993",
    expect: { canonical: "Demurrer", target: "SAC" },
  },
  {
    name: "spec-05 motion to strike",
    raw: "DEFENDANT BLUE SHIELD'S MOTION TO STRIKE PUNITIVE DAMAGES IN SECOND AMENDED COMPLAINT CASE NO. 25STCV30016",
    expect: { canonical: "Motion", target: "Mot. to Strike Punitive Damages" },
  },
  {
    name: "spec-06 experian's motion to compel arbitration",
    raw: "EXPERIAN'S MOTION TO COMPEL ARBITRATION AND FOR A STAY",
    expect: { canonical: "Motion", target: "Mot. to Compel Arbitration and for a Stay" },
  },
  {
    name: "spec-07 smith decl ISO mot",
    raw: "SMITH DECL. I/S/O EXPERIAN'S MOTION TO COMPEL ARBITRATION AND FOR A STAY",
    expect: { canonical: "Smith Decl. ISO Mot." },
  },
  {
    name: "spec-08 hroshovyk decl ISO opp",
    raw: "DECLARATION OF VIKTORIIA HROSHOVYK IN SUPPORT OF PLAINTIFF'S OPPOSITION TO EXPERIAN'S MOTION TO COMPEL ARBITRATION",
    expect: { canonical: "Hroshovyk Decl. ISO Opp." },
  },
  {
    name: "spec-09 opp to mot. to compel arb",
    raw: "PLAINTIFF'S OPPOSITION TO EXPERIAN'S MOTION TO COMPEL ARBITRATION",
    expect: { canonical: "Opposition", target: "Mot." },
  },
  {
    name: "spec-10 aranyi decl",
    raw: "ARANYI DECLARATION",
    expect: { canonical: "Aranyi Decl." },
  },
  {
    name: "spec-11 walder decl ISO opp",
    raw: "DECLARATION OF JARED WALDER IN SUPPORT OF PLAINTIFF'S OPPOSITION TO EXPERIAN'S MOTION TO COMPEL ARBITRATION",
    expect: { canonical: "Walder Decl. ISO Opp." },
  },
  {
    name: "spec-12 demurrer to FAC",
    raw: "DEFENDANT THE REGENTS OF THE UNIVERSITY OF CALIFORNIA'S NOTICE OF DEMURRER AND DEMURRER TO PLAINTIFF'S First Amended Complaint (FAC)",
    expect: { canonical: "Demurrer", target: "FAC" },
  },
  {
    name: "spec-13 singleton complaint",
    raw: "COMPLAINT FOR COMPENSATORY, PUNITIVE, AND LIQUIDATED DAMAGES, INJUNCTIVE RELIEF, AND CIVIL PENALTIES SINGLETON V. AIR TUTORS LLC, ET AL",
    expect: { canonical: "Complaint", party: "Singleton" },
  },
  ...
  },
  {
    ...
    raw: "Defendant Blue Shield's Reply to Opposition to Ex Parte Application",
    expect: { canonical: "Reply", target: "Opp. to Ex Parte App.", partyLabel: "Blue Shield" },
  },
  {
  ...
  },
  {
    ...
    raw: "Defendant Blue Shield's Demurrer to SAC",
    expect: { canonical: "Demurrer", target: "SAC", partyLabel: "Blue Shield" },
  },
  {
  ...
  },
  {
    ...
    raw: "Experian's Motion to Compel Arbitration",
    expect: { canonical: "Motion", partyLabel: "Experian" },
  },
  {
    name: "party-labeled-with-name",
    raw: "Plaintiff Dana Zahler's Opposition to Defendant's Motion",
    expect: { canonical: "Opposition", target: "Mot.", partyLabel: "Dana Zahler" },
  },
  {
  ...
  // === Request for Judicial Notice ===
  {
    ...
    raw: "Plaintiffs Req for Judicial Notice in Support Opp to Demurrer by Duggan & Hollingshead TAC",
  ...
  {
    name: "sep-stmt-reply",
    raw: "TAYLOR BROTHERS ARCHITECTURAL PRODUCTS, INC.'S SEPARATE STATEMENT IN REPLY TO PLAINTIFF'S ADDITIONAL MATERIAL FACTS RE: MOTION FOR SUMMARY JUDGMENT",
  ...
  // find the actual ISO clause downstream.
  {
    ...
    raw: "DECLARATION OF JASSON GOLRIZ, ESQ AND PLAINTIFF'S COMPENDIUM OF EXHIBITS IN SUPPORT OF PLAINTIFF'S OPPOSITION TO MOTION SUMMARY JUDGMENT",
    expect: { canonical: "Golriz Decl. ISO Opp." },
  },
];
...
dtest("two complaints (one with party)", [
  ...
  { id: "b", canonical: "Complaint", party: "Singleton" },
], { a: "Complaint", b: "Singleton Complaint" });
...
dtest("level2: two demurrers same target different names", [
  { id: "a", canonical: "Demurrer", target: "SAC", partyLabel: "Blue Shield" },
  { id: "b", canonical: "Demurrer", target: "SAC", partyLabel: "Experian" },
], { a: "Blue Shield's Demurrer", b: "Experian's Demurrer" });
...
dtest("two defendants one named one not", [
  ...
  { id: "b", canonical: "Motion", target: "Mot. to Strike", partyLabel: "Blue Shield" },
], {
  a: "Defendant's Motion",
  b: "Blue Shield's Motion",
});
