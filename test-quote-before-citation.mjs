...
// whole short cite in. Reported separately from the quotation shape; same root
// cause, which is why ")" and "]" are stripped alongside the quotes.
const NGUYEN = "Nguyen v. Applied Medical Resources Corp. (2016) 4 Cal.App.5th 232";
check(
